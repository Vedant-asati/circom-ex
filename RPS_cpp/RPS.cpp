...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 1],&circuitConstants[6]); // line circom 15
Fr_mul(&expaux[1],&signalValues[mySignalStart + 3],&expaux[3]); // line circom 15
...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 20
Fr_mul(&expaux[1],&signalValues[mySignalStart + 4],&expaux[3]); // line circom 20
...
Fr_sub(&expaux[5],&circuitConstants[5],&signalValues[mySignalStart + 8]); // line circom 67
Fr_sub(&expaux[3],&signalValues[mySignalStart + 9],&expaux[5]); // line circom 67
Fr_mul(&expaux[1],&signalValues[mySignalStart + 6],&expaux[3]); // line circom 67
...
assert(Fr_isTrue(&expaux[0]));
Fr_sub(&expaux[2],&circuitConstants[1],&signalValues[mySignalStart + 6]); // line circom 68
Fr_add(&expaux[5],&signalValues[mySignalStart + 8],&circuitConstants[1]); // line circom 68
Fr_sub(&expaux[3],&signalValues[mySignalStart + 9],&expaux[5]); // line circom 68
Fr_mul(&expaux[1],&expaux[2],&expaux[3]); // line circom 68
...
Fr_mul(&expaux[1],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 0]); // line circom 79
...
assert(Fr_isTrue(&expaux[0]));
Fr_sub(&expaux[2],&signalValues[mySignalStart + 7],&circuitConstants[1]); // line circom 80
Fr_sub(&expaux[3],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 9]); // line circom 80
Fr_mul(&expaux[1],&expaux[2],&expaux[3]); // line circom 80
